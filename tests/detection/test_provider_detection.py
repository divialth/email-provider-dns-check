...
def _provider(provider_id, mx_hosts, variables=None):
    return ProviderConfig(
        ...
        version="1",
        mx=MXConfig(
            required=[MXRecord(host=host) for host in mx_hosts],
            optional=[],
        ),
        spf=None,
        dkim=None,
...
def test_detect_providers_supports_a_only(monkeypatch):
    provider = ProviderConfig(
        ...
        spf=None,
        dkim=None,
        a=AddressConfig(required={"@": ["192.0.2.1"]}, optional={}),
        aaaa=None,
        txt=None,
        dmarc=None,
        variables={},
...
def test_detect_providers_supports_aaaa_only(monkeypatch):
    provider = ProviderConfig(
        ...
        dkim=None,
        a=None,
        aaaa=AddressConfig(required={"@": ["2001:db8::1"]}, optional={}),
        txt=None,
        dmarc=None,
        variables={},
    )
...
def test_detect_providers_breaks_ties_with_optional_bonus(monkeypatch):
    provider_alpha = ProviderConfig(
        ...
        spf=None,
        dkim=None,
        cname=CNAMEConfig(required={}, optional={"autoconfig": "auto.alpha.test."}),
        srv=None,
        txt=None,
        dmarc=None,
        variables={},
    ...
    provider_beta = ProviderConfig(
        ...
        spf=None,
        dkim=None,
        cname=CNAMEConfig(required={}, optional={"autoconfig": "auto.beta.test."}),
        srv=None,
        txt=None,
        dmarc=None,
        variables={},
