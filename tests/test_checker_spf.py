    ...
    provider = ProviderConfig(
        ...
        spf=SPFConfig(
            required=SPFRequired(
                record="v=spf1 include:strict.example -all",
...
def test_spf_multiple_records_fail():
    provider = ProviderConfig(
        ...
        spf=SPFConfig(
            required=SPFRequired(
                record="v=spf1 include:multi.example -all",
...
def test_spf_allowed_mechanisms_pass():
    provider = ProviderConfig(
        ...
        spf=SPFConfig(
            ...
            optional=SPFOptional(mechanisms=["a", "mx"], modifiers={}),
        ),
        dkim=None,
        txt=None,
        dmarc=None,
    ...
    provider = ProviderConfig(
        ...
        spf=SPFConfig(
            required=SPFRequired(
                ...
                includes=[],
                mechanisms=[],
                modifiers={"redirect": "_spf.example.test"},
            ),
            optional=SPFOptional(mechanisms=[], modifiers={}),
        ),
        dkim=None,
    ...
    provider = ProviderConfig(
        ...
        spf=SPFConfig(
            ...
            optional=SPFOptional(
                mechanisms=[],
                modifiers={"exp": "explain._spf.example.test"},
            ),
        ),
        dkim=None,
        txt=None,
...
def test_spf_required_and_allowed_mechanisms_cover_base():
    provider = ProviderConfig(
        ...
        spf=SPFConfig(
            ...
            optional=SPFOptional(mechanisms=["mx"], modifiers={}),
        ),
        dkim=None,
        txt=None,
        dmarc=None,
...
def test_spf_allowed_mechanism_with_qualifier_passes():
    provider = ProviderConfig(
        ...
        spf=SPFConfig(
            ...
            optional=SPFOptional(mechanisms=["-ptr"], modifiers={}),
        ),
        dkim=None,
        txt=None,
        dmarc=None,
